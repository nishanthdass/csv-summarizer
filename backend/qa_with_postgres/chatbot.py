...
class ChatBot():
    ...
    def __init__(self,  table_name: str):
        ...
        self.db = SQLDatabase.from_uri(APPCFG.connection_string, include_tables=[table_name])
    ...
    def respond(self, chatbot: List, message: str) -> Tuple:
        ...
        print(self.write_query)
        response = self.chain.invoke({"question": message["question"], "table": message["table"]})
        chatbot.append((message, response))
        return "", chatbot
    
    def get_response(self, question: str, table_name: str) -> str:
        """
        Generate a response to a question based on a specific table.

        Args:
            question (str): The user's input question.
            table_name (str): The database table name to target for queries.
            
        Returns:
            str: The response generated by the chatbot.
        """
        # Invoke the chain with the current question and table name
        response = self.chain.invoke({"question": question, "table": table_name})
        return response
